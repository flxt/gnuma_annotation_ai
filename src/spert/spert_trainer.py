...
from src.spert import models
from src.spert import prediction, sampling, util
from src.spert.entities import Dataset
from src.spert.evaluator import Evaluator
from src.spert.input_reader import BaseInputReader
from src.spert.loss import SpERTLoss, Loss
from tqdm import tqdm
from src.spert.trainer import BaseTrainer
...
class SpERTTrainer(BaseTrainer):
    ...
    def train(self, train_path: str, valid_path: str, types_path: str, input_reader_cls: Type[BaseInputReader]):
        ...
        #optimizer = torch.optim.SGD(optimizer_params, lr=args.lr, momentum=0.9, nesterov=True, weight_decay=args.weight_decay)
        # create scheduler
